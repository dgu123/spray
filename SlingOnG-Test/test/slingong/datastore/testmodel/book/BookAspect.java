...
public class BookAspect {
	...
	@Pointcut( "execution( public void springadaptslim3.orm.testdomain.Book.setAuthorPriority( ..))")
	...
	// Used join point to get necessary argument instead of using args for pointcut 
	// because method signature may change.
	@Pointcut( "execution( public void springadaptslim3.orm.testdomain.Book.addNewChapter( ..))")
